...
// import * as d3annotation from './d3-annotation';
...
function initializeGraph() {
    ...
    // Uniform with other viz.
    svg = d3.select("#container-2")
        .append("svg")
...
function updateGraph() {
    ...
    annotation = nodeContainer
      .append("text")
        .text(d => { console.log(d); return d.id })
        .attr('class', 'annotation')
        .attr('x', nodeRadius)
        .attr('y', d => { return -nodeRadius(d) });
